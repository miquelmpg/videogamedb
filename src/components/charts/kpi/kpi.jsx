function KPI({ data, parameter }) {
    ...
    return (
        <div className="d-flex flex-column fs-1 border border-dark rounded-pill align-items-center justify-content-center text-center fw-semibold" style={{width: '400px'}}>
